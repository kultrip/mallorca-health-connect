      ...
      <div className="mx-auto max-w-[1180px] px-6 pb-24 pt-12 md:px-10 md:pt-16">
        ...
        <div className="rounded-3xl border border-dashed border-border bg-[#fffaf5]/40 p-8 md:p-10 mb-16 shadow-sm max-w-4xl">
          ...
          <div className="space-y-4 text-base text-foreground/90 leading-relaxed font-sans">
            <p>
              Mallorca Holística reúne a profesionales de la salud complementaria e integrativa,
              centros y organizaciones que comparten una visión más integradora, humana y consciente
              del bienestar y del acompañamiento a las personas.
            </p>
            <p>
              Cada profesional, cada centro y cada organización aportan una mirada única. Juntos
              formamos una comunidad basada en la confianza, la profesionalidad y el compromiso.
            </p>
        ...
        <div className="grid gap-8 md:grid-cols-3 mb-16">
          ...
          <div className="flex flex-col justify-between rounded-3xl border border-border/80 bg-card p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all duration-300">
            <div>
              ...
              <p className="mt-6 text-sm leading-relaxed text-muted-foreground font-sans">
                Para profesionales de la salud complementaria e integrativa que desean dar
                visibilidad a su actividad y empezar a formar parte de Mallorca Holística.
              </p>
            </div>
            ...
            <div className="mt-8 pt-4">
              <Button
                asChild
                className="w-full bg-transparent border border-[#526046]/40 hover:bg-[#526046]/5 text-[#526046] rounded-xl font-medium"
                variant="outline"
              >
                <Link to="/plan-presencia">👉 Descubrir el plan</Link>
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between rounded-3xl border border-border/80 bg-card p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all duration-300">
            <div>
              ...
              <div className="mt-4 space-y-2">
                <span className="text-2xl font-bold text-foreground block">
                  25 €/mes{" "}
                  <span className="text-sm font-normal text-muted-foreground">(IVA incluido)</span>
                </span>
                <div className="text-xs font-semibold text-emerald-800 bg-emerald-50 px-2.5 py-1 rounded-full inline-flex items-center gap-1">
                  Comunidad Fundadora: 180 dias sin cargo y tarifa especial
                </div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-muted-foreground font-sans">
                ...
                confianza que transmiten, aumentar su visibilidad y acceder a funcionalidades
                avanzadas.
              </p>
            </div>
            ...
            <div className="mt-8 pt-4">
              <Button
                asChild
                className="w-full bg-[#526046] hover:bg-[#434f3a] text-white rounded-xl font-medium"
              >
                <Link to="/profesional-fundador">👉 Descubrir el plan</Link>
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between rounded-3xl border border-border/80 bg-card p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all duration-300">
            ...
            <div className="mt-8 pt-4">
              <Button
                ...
                variant="outline"
              >
                <Link to="/comunidad-fundadora-organizaciones">👉 Descubrir el plan</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-primary/20 bg-[#fdf5eb] p-8 md:p-12 shadow-sm text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="mt-3.5 text-sm md:text-base leading-relaxed text-muted-foreground font-sans">
              Si has recibido una invitación personal para formar parte de la Comunidad Fundadora de
              Mallorca Holística, puedes acceder aquí para activar tus condiciones especiales.
            </p>
            ...
            <div className="mt-8 flex justify-center">
              <Button
                asChild
                size="lg"
                className="bg-[#526046] hover:bg-[#434f3a] text-[#fffaf3] rounded-xl px-8 shadow-sm"
              >
