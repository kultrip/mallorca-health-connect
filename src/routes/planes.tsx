      ...
      <div className="mx-auto max-w-[1180px] px-6 pb-24 md:px-10">
        ...
        <div className="mt-16 rounded-3xl border border-border bg-secondary/30 p-8 md:p-12">
          ...
          <p className="mt-4 max-w-2xl text-muted-foreground">
            Reservado para los primeros perfiles seleccionados. Seis meses gratuitos
            desde el lanzamiento, luego una tarifa especial mantenida durante 24 meses.
          </p>
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-border bg-background p-6">
              <h3 className="font-display text-xl">Profesional</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Primeros 40 perfiles. 6 meses gratis, después 15€/mes durante 24 meses.
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-background p-6">
              <h3 className="font-display text-xl">Centros & Organizadores</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Primeros 10 perfiles. 6 meses gratis, después 35€/mes durante 24 meses.
              </p>
            </div>
          </div>
        </div>
