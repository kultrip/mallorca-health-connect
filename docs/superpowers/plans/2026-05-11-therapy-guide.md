...
- Create `src/routes/therapies_.$slug.tsx`: canonical therapy detail route.
- Create `src/routes/terapias_.$slug.tsx`: Spanish compatibility redirect to `/therapies/$slug`.
...
```bash
npm run build
npx eslint src/features/therapies/TherapyDetailPage.tsx 'src/routes/therapies_.$slug.tsx' src/lib/routes.ts
```
...
```bash
git add src/features/therapies/TherapyDetailPage.tsx 'src/routes/therapies_.$slug.tsx' src/lib/routes.ts src/routeTree.gen.ts
...
```bash
npm run build
npx eslint src/lib/redirects.ts 'src/routes/terapias_.$slug.tsx'
```
...
```bash
git add src/lib/redirects.ts 'src/routes/terapias_.$slug.tsx' src/routeTree.gen.ts
...
- `redirectTherapySlug` is defined before `src/routes/terapias_.$slug.tsx` imports it.
