...
const reference = {
  municipalities: [
    ...
    { slug: "marratxi", name: "Marratxi", lat: 39.6212, lng: 2.7256 },
    { slug: "inca", name: "Inca", lat: 39.7211, lng: 2.9116 },
    { slug: "soller", name: "Soller", lat: 39.7662, lng: 2.7152 },
    { slug: "manacor", name: "Manacor", lat: 39.5697, lng: 3.2096 },
    { slug: "calvia", name: "Calvia", lat: 39.5657, lng: 2.5062 },
  ],
  therapies: [
    {
      slug: "reiki",
