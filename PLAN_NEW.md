...
The application operates under three distinct subscription tiers and a separate authenticated role for end consumers (*Usuarios Particulares*). AI agents must enforce the exact routing sequences and structural rules defined below.
...
| **Paso 7** | `💳 Suscripción y Pago` | *Bypassed* | Founder Stripe Gateway Capture Panel + SetupIntent Consent Form | Founder Stripe Gateway Capture Panel + SetupIntent Consent Form |
...
### 4.2 Specializations & Therapies Taxonomy (*Especialidades y Terapias*)
...
### 4.3 Health Issues & Focus Areas Taxonomy (*Áreas de Especialización*)
...
### 5.3 Double-Sided Role Provisioning: End Consumers (*Usuarios Particulares*)
...
* **Private Review Controls:** Authenticated *Usuarios Particulares* gain access to post qualitative reviews on paid member profiles.
